use crate::{event_queue, type_traits::*, types::*, widget_queue::*};
    ...
    WkrPool<Ft, EvntTp, WkrPpty>
{
    ...
    ) -> (event_queue::Sender<Ft, EvntTp>, mpsc::Receiver<RtEvnt>, Self) {
        let (evnt_pipe_sndr, evnt_pipe_rcvr) = event_queue::make_channel();
